...
Instance subA : sub A := (fun x y => x - y)%R.
...
(* scaling *)
(* Lemma refines_seqpoly_scale (x : A) (p : {poly A}) (s : seqpoly A) *)
...
(* shifting = * 'X^n *)
(* Instance refines_seqpoly_shift n (p : {poly A}) (s : seqpoly A) *)
...
(* Instance refines_seqpoly_cons a (p : {poly A}) (s : seqpoly A) *)
