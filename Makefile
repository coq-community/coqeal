...
# coq_makefile -f Make2 -o Makefile 
#
...
CAMLP4OPTIONS:=
COQC=~/coqfinitgroup/ssreflect/ssreflect1.3_v8.3/bin/ssrcoq
COQFLAGS=-q $(OPT) -I ~/coqfinitgroup -dont-load-proofs $(COQLIBS) $(OTHERFLAGS) $(COQ_XML) -compile
...
VFILES:=ssrcomplements.v\
  ...
  winograd.v\
  mxstructure.v\
  examples/ex_cseqpoly.v\
  examples/ex_karatsuba.v\
  examples/ex_winograd.v\
  examples/ex_Q.v\
  examples/ex_Z.v
VOFILES:=$(VFILES:.v=.vo)
...
Makefile: Make2
	...
	$(COQBIN)coq_makefile -f Make2 -o Makefile
