...
Context `{forall m n, refinement (@Rseqmx A m n)}.
Context `{forall m n, param (refines ==> refines ==> refines) (@addmx A m n)
  (@hadd_op _ _ _ m n)}.
Context `{forall m n p, param (refines ==> refines ==> refines) (@mulmx A m n p)
  (@hmul_op _ _ _ m n p)}.
